			...
			<div class="we7-form">
				<div class="col-sm-6 we7-padding">
					...
					<div class="form-group">
					  ...
					  <div class="form-controls col-sm-9 ">
						  <input type="text" readonly="readonly" name="ip_t" value="https://0418it.taobao.com" class="form-control">
					  </div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label">网站URL</label>
					  <div class="form-controls col-sm-9 ">
						  <input type="text" readonly="readonly" name="url_t" value="https://0418it.taobao.com"  class="form-control">
					  </div>
					</div>
				...
				<div class="col-sm-6 we7-padding">
						...
						<div class="form-group">
						  ...
						  <div class="form-controls col-sm-9 ">
							  <input name="contact" type="text" class="form-control"  value="清峰网络科技"  id="contact" readonly="readonly" >
