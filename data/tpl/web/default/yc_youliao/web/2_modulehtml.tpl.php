...
<section id="content">
	<section class="vbox">
		<section class="scrollable padder">
			...
			<link rel="stylesheet" href="<?php echo SQ;?>public/css/channel.css"/>
			<link rel="stylesheet" href="<?php echo SQ;?>public/css/diy_channel.css"/>
...
<div class="messimain">
	...
	<div class="deigner">
		...
		<div class="deigner-title">
			<span class="ng-binding"><?php  echo $moduleres['name'];?></span>
		</div>
			...
			<li>
				<div class="list_messi_text_oneimg" style="background:#fff;margin-bottom:0.2rem;">
					<div class="img_item text-c">
						<img src="<?php echo SQ;?>public/images/quesheng.jpg" />
					</div>
	...
	<div class="deigner" style="float:right;">
		...
		<ul class="deigner-body" id="autocontent"><?php  if($showhtml) { ?><?php  echo $showhtml;?><?php  } ?></ul>
	</div>	
</div>
...
<div class="alerts hide">
	<div class="alert">
		...
		<div class="allfields">
			<?php  if(is_array($fieldslist)) { foreach($fieldslist as $frow) { ?>
				<span data-enname="<?php  echo $frow['enname'];?>" class="noneizhi"><?php  echo $frow['showname'];?></span>
			<?php  } } ?>
