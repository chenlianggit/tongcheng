                                    ...
                                    <div class="col-sm-9 col-xs-12">
                                        <div class="input_form item_cell_flex checkbox good_inco_list">
                                            <div class="inco_append_box"><?php  $item['inco']=json_decode($item['inco'])?>
                                                ...
                                                <label><input type="checkbox" name="inco[]" <?php  if(in_array('干净卫生',(array)$item['inco'])) { ?>checked="checked"<?php  } ?> value="干净卫生" > 干净卫生</label>
                                                <label><input type="checkbox" name="inco[]" <?php  if(in_array('环境优雅',(array)$item['inco'])) { ?>checked="checked"<?php  } ?> value="环境优雅" > 环境优雅</label>

                                                <?php  if(is_array($item['inco'])) { foreach($item['inco'] as $i) { ?>
                                                <?php  if(!in_array($i,array('干净卫生','环境优雅'))) { ?>
                                                <label>
