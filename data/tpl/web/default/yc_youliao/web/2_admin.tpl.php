...
<section >
    <section class="padder">
        ...
        <ul class="nav nav-tabs">
            <li <?php  if($op =='display') { ?> class="active" <?php  } ?>><a href="<?php  echo $this->createWebUrl('admin',array('op' =>'display'))?>">管理员列表</a></li>
            <?php  if($op =='post') { ?> <li  class="active" ><a href="<?php  echo $this->createWebUrl('admin',array('op' =>'post'))?>"> 编辑管理员信息</a></li><?php  } ?>
                        ...
                        <div class="tableBox">
                            ...
                            <table bordercolor="#dbdbdb" cellspacing="0" width="100%" border="1px"  class="tablestyle" >
                                ...
                                <tr>
                                    ...
                                    <td class="listbtn">
                                        <a href="<?php  echo $this->createWebUrl('admin', array('op' => 'post', 'admin_id' => $item['admin_id']))?>"><i class="fa fa-edit"></i>修改</a>
                                        <a class="label label-danger pad-5 " href="<?php  echo $this->createWebUrl('admin', array('op' => 'delete', 'admin_id' => $item['admin_id']))?>"><i class="fa fa-exclamation-triangle"></i>删除</a>
                                    </td>
                    ...
                    <form  action="" method="post" class="form-horizontal form" enctype="multipart/form-data">
                        ...
                        <div>
                            ...
                            <div class="width100 btn2">
                                <input name="submit" type="submit" value="提交" class="btn btn-primary" onclick="return checkAdmin_role(this.form)">
                            </div>
