			...
			<div class="container ">
				...
				<div class="collapse navbar-collapse">
					<ul class="nav navbar-nav navbar-left">
						...
						<li<?php  if($_GPC['m'] == 'store') { ?> class="active"<?php  } ?>><a href="./index.php?c=home&a=welcome&do=ext&m=store" style="display:none;" >商城</a></li>
						<?php  } ?>
					</ul>
					...
					<div class="left-menu-content">
						<div class="left-menu-top skin-black">
							<div class="account-info-name">
								...
								<span class="account-name"><a href="./index.php?c=home&a=welcome&do=account&" style="display:none;">商城</a></span>
							</div>
						</div>
...
<div class="panel panel-content main-panel-content">
	<div class="content-head panel-heading main-panel-heading">
		<span class="font-lg" style="display:none;"><i class="wi wi-store"></i> 商城</span></div>
	<div class="panel-body clearfix main-panel-body">
		<div class="left-menu">
			<div class="left-menu-content">
				<?php  if(is_array($this->left_menus)) { foreach($this->left_menus as $key => $menus) { ?>
